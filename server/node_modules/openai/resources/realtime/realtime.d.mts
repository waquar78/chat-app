...
import { ClientSecretCreateParams, ClientSecretCreateResponse, ClientSecrets, RealtimeSessionCreateResponse } from "./client-secrets.mjs";
...
export interface RealtimeSessionCreateRequest {
     ...
     * The Realtime model used for this session.
     */
    model: (string & {}) | 'gpt-4o-realtime' | 'gpt-4o-mini-realtime' | 'gpt-4o-realtime-preview' | 'gpt-4o-realtime-preview-2024-10-01' | 'gpt-4o-realtime-preview-2024-12-17' | 'gpt-4o-realtime-preview-2025-06-03' | 'gpt-4o-mini-realtime-preview' | 'gpt-4o-mini-realtime-preview-2024-12-17';
    /**
